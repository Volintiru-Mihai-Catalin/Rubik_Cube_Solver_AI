...
from .constants import MOVES, CORNERS, COLORS, LETTERS, CUBLETS
...
class Cube:
    ...
    @staticmethod
    def hash_to_state(hashed_state : str) -> np.ndarray:
        return np.fromiter(map(int, hashed_state), dtype=int)
